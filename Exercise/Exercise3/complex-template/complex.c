...
/* Equal */
static bool
complex_abs_eq_internal(Complex* c, Complex* d)
{
    return sqrt(c->a * c->a + c->b * c->b)==sqrt(d->a * d->a + d->b * d->b);
}
...
complex_abs_eq(PG_FUNCTION_ARGS)
{
    Complex* c = PG_GETARG_COMPLEX_P(0);
    Complex* d = PG_GETARG_COMPLEX_P(1);
    bool result = complex_abs_eq_internal(c, d);
    PG_FREE_IF_COPY(c, 0);
    PG_FREE_IF_COPY(d, 1);
    PG_RETURN_BOOL(result);
}
...
static bool
complex_abs_lt_internal(Complex* c, Complex* d)
{
    return sqrt(c->a * c->a + c->b * c->b) < sqrt(d->a * d->a + d->b * d->b);
}
...
complex_abs_lt(PG_FUNCTION_ARGS)
{
    Complex* c = PG_GETARG_COMPLEX_P(0);
    Complex* d = PG_GETARG_COMPLEX_P(1);
    bool result = complex_abs_lt_internal(c, d);
    PG_FREE_IF_COPY(c, 0);
    PG_FREE_IF_COPY(d, 1);
    PG_RETURN_BOOL(result);
}
...
static bool
complex_abs_lte_internal(Complex* c, Complex* d)
{
    return sqrt(c->a * c->a + c->b * c->b) <= sqrt(d->a * d->a + d->b * d->b);
}


PG_FUNCTION_INFO_V1(complex_abs_lte);
Datum
complex_abs_lte(PG_FUNCTION_ARGS)
{
    Complex* c = PG_GETARG_COMPLEX_P(0);
    Complex* d = PG_GETARG_COMPLEX_P(1);
    bool result = complex_abs_lte_internal(c, d);
    PG_FREE_IF_COPY(c, 0);
    PG_FREE_IF_COPY(d, 1);
    PG_RETURN_BOOL(result);
}
...
static bool
complex_abs_gt_internal(Complex* c, Complex* d)
{
    return sqrt(c->a * c->a + c->b * c->b) > sqrt(d->a * d->a + d->b * d->b);
}
...
complex_abs_gt(PG_FUNCTION_ARGS)
{
    Complex* c = PG_GETARG_COMPLEX_P(0);
    Complex* d = PG_GETARG_COMPLEX_P(1);
    bool result = complex_abs_gt_internal(c, d);
    PG_FREE_IF_COPY(c, 0);
    PG_FREE_IF_COPY(d, 1);
    PG_RETURN_BOOL(result);
}
...
static bool
complex_abs_gte_internal(Complex* c, Complex* d)
{
    return sqrt(c->a * c->a + c->b * c->b) >= sqrt(d->a * d->a + d->b * d->b);
}


PG_FUNCTION_INFO_V1(complex_abs_gte);
Datum
complex_abs_gte(PG_FUNCTION_ARGS)
{
    Complex* c = PG_GETARG_COMPLEX_P(0);
    Complex* d = PG_GETARG_COMPLEX_P(1);
    bool result = complex_abs_gte_internal(c, d);
    PG_FREE_IF_COPY(c, 0);
    PG_FREE_IF_COPY(d, 1);
    PG_RETURN_BOOL(result);
}
...
static int
complex_cmp_internal(Complex* c, Complex* d)
{
    if (complex_abs_lt_internal(c,d)==1){
        return -1;
    }
    else if (complex_abs_eq_internal(c, d) == 1) {
        return 0;
    }
    else if (complex_abs_gt_internal(c, d) == 1) {
        return 1;
    }
}
...
complex_cmp(PG_FUNCTION_ARGS)
{
    Complex* c = PG_GETARG_COMPLEX_P(0);
    Complex* d = PG_GETARG_COMPLEX_P(1);
    int result = complex_cmp_internal(c, d);
    PG_FREE_IF_COPY(c, 0);
    PG_FREE_IF_COPY(d, 1);
